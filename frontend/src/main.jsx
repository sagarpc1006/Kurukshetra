...
function Landing(){return <><Navbar/><main className="landing">
 <section className="hero"><div className="hero-copy"><Pill>✦ Travel thoughtfully, beautifully</Pill><h1>Every journey can be<br/><i>a greener one.</i></h1><p className="hero-tagline">Thoughtful travel. Meaningful impact.</p><div className="hero-buttons"><Link className="btn" to="/signup">Plan your eco-trip <b>↗</b></Link></div><div className="hero-proof"><b>4.9/5</b><span className="avatars">◉ ◉ ◉ ◉</span><span>Loved by 40,000+ mindful travellers</span></div></div>
 <div className="hero-art"><div className="sun"></div><div className="mountain m1"></div><div className="mountain m2"></div><div className="mountain m3"></div><div className="cloud c1"></div><div className="cloud c2"></div><div className="route">⌁</div><div className="float-card card-a">🌿 <b>42% less CO₂</b><small>Your journey, made lighter</small></div><div className="float-card card-b">✦ <b>Comfort, checked</b><small>Access & hygiene verified</small></div></div></section>
